...
public class RoomController : MonoBehaviour
{
    ...
    /// 这个房间清空后要解锁的门
    /// 
    /// 当前先直接复用 RoomExitTriggerTester 作为“门对象脚本”。
    /// 后面如果你要把门再拆得更干净，可以再单独拆 Door 脚本。
    /// </summary>
    [SerializeField] private RoomExitTriggerTester[] roomDoors;
    ...
    /// 统一设置这个房间的门是否解锁
    /// 
    /// 当前门对象继续用 RoomExitTriggerTester 承担“显示 + 触发器开关”。
    /// </summary>
